        ...
        function contentedtiableAutocomplete($) {
            ...
            var ContenteditableAutocomplete = function (el) {
                ...
                function initialize() {
                    ...
                    $suggestions.append('<div>Directive</div>')
                    $suggestions.hide()
                ...
                function handleNewSuggestions(suggestions) {
                    ...
                    currentValues = currentValue.split(regexSplitWordsWithWhitespace)
                ...
                function getCurrentQuery() {
                    ...
                    for (var i = 0; i < words.length; i++) {
                        ...
                        if (charCount + word.length >= cursorAt) {
                            return currentValue.substring(charCount, cursorAt)
                        }
                ...
                function replaceCurrentWordWith(newWord) {
                    ...
                    for (var i = 0; i < words.length; i++) {
                        ...
                        if (charCount + word.length >= cursorAt) {
                            beforeQuery = currentValue.substring(0, charCount)
